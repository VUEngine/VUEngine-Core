...
//{{BLOCK(VBJaEngineDefaultAdjustmentScreenIcon)

//======================================================================
//
//	VBJaEngineDefaultAdjustmentScreenIcon, 16x16@2, 
...
const unsigned int VBJaEngineDefaultAdjustmentScreenIconTiles[20] __attribute__((aligned(4)))=
{
...
const unsigned short VBJaEngineDefaultAdjustmentScreenIconMap[4] __attribute__((aligned(4)))=
{
