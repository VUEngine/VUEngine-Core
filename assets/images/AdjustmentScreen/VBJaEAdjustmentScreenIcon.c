...
//{{BLOCK(VBJaEAdjustmentScreenIcon)

//======================================================================
//
//	VBJaEAdjustmentScreenIcon, 16x16@2, 
...
const unsigned int VBJaEAdjustmentScreenIconTiles[20] __attribute__((aligned(4)))=
{
...
const unsigned short VBJaEAdjustmentScreenIconMap[4] __attribute__((aligned(4)))=
{
