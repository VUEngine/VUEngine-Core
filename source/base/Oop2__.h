...
#define ___PARAMETERS(...)  ,__VA_ARGS__
#define ___ARGUMENTS(...)  ,__VA_ARGS__

/*--------------------------------------------------------------------------------------------------------------------------------*/
// concatenate two strigs
#define ___MAKE_CONCAT(str_1,str_2) str_1 ## str_2
#define ___CONCAT(str_1,str_2) __MAKE_CONCAT(str_1,str_2)


/*--------------------------------------------------------------------------------------------------------------------------------*/
// declaration helpers
#define _SUPER_METHODS __CONCAT(SUPER_CLASS, _METHODS)
#define _SUPER_SET_VTABLE __CONCAT(SUPER_CLASS, _SET_VTABLE)
#define _SUPER_ATTRIBUTES __CONCAT(SUPER_CLASS, _ATTRIBUTES)

/*--------------------------------------------------------------------------------------------------------------------------------*/
// call to this method only once
#define ___CALL_ONCE(MethodName, ...)				\
													\
	{												\
		/* a static flag */							\
...
#define ___DEFINE_CHECK_VTABLE(ClassName)								\
																		\
...
#define ___CHECK_VTABLE(ClassName)							\
															\
...
#define ___ALLOCATOR_DEFINITION(ClassName)									\
																			\
	/* define allocator */													\
...
#define ___CLASS_NEW_DECLARE(ClassName, ...)							\
																	\
	/* define the method */											\
...
#define ___CLASS_NEW_DEFINITION(ClassName, ...)						\
																	\
...
#define ___CLASS_NEW_END(ClassName, ...)								\
																	\
...
#define ___CONSTRUCT_BASE(...)											\
																		\
	/* make sure the this pointer is initialized */						\
	ASSERT(this, __CONCAT(SUPER_CLASS,_constructor));					\
																		\
	/* call super constructor */										\
	__CONCAT(SUPER_CLASS, _constructor((SUPER_CLASS)this __VA_ARGS__));				


/*--------------------------------------------------------------------------------------------------------------------------------*/
// must always call base class's destructor
#define ___DESTROY_BASE												\
																	\
	/* call super class's destructor */								\
	__CONCAT(SUPER_CLASS,_destructor((SUPER_CLASS)this);			\
																	\
...
#define ___VIRTUAL_CALL_ADDRESS(ClassName, MethodName, Object, ...)					\
																					\
...
#ifdef __DEBUG																		
#define ___VIRTUAL_CALL(ReturnType, ClassName, MethodName, Object, ...)						\
		(																					\
...
/*--------------------------------------------------------------------------------------------------------------------------------*/
// cast macro
#define ___GET_CAST(ClassName, Object)																\
		(																							\
...
#define ___VIRTUAL_DEC(MethodName)					\
													\
...
#define ___VIRTUAL_SET(ClassVTable, ClassName, MethodName)								\
																						\
...
#define ___SET_VTABLE(ClassName, SuperClass)								\
																		\
...
/*--------------------------------------------------------------------------------------------------------------------------------*/
// define a class
#define ___CLASS_DEFINITION(ClassName, SuperClass)				\
																\
	...
	__SET_VTABLE(ClassName, SuperClass)							

																		
/*--------------------------------------------------------------------------------------------------------------------------------*/
// declare an object type
#define ___TYPE(ClassName)	ClassName ## _new

/*--------------------------------------------------------------------------------------------------------------------------------*/
// defines a singleton (unique instance of a class)
#define ___SINGLETON(ClassName)										\
																	\
...
/*--------------------------------------------------------------------------------------------------------------------------------*/
// must always call base class's destructor
#define ___SINGLETON_DESTROY(SuperClass)								\
																	\
...
#define ___SINGLETON_DYNAMIC(ClassName)								\
																	\
...
#define ___CALL_VARIADIC(VariadicFunctionCall)						\
																	\
