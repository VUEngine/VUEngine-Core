...
static void Clock::printDeciseconds(uint32 milliseconds, int32 col, int32 row, const char* font)
{
	...
	Printer::int32(deciSeconds, col, row, font);
}
...
static void Clock::printCentiseconds(uint32 milliseconds, int32 col, int32 row, const char* font)
{
	...
	if(centiSeconds >= 10)
	{
		Printer::int32(centiSeconds, col, row, font);
	}
	else
	{
		Printer::int32(0, col, row, font);
		Printer::int32(centiSeconds, col + 1, row, font);
	}
}
...
static void Clock::printMilliseconds(uint32 milliseconds, int32 col, int32 row, const char* font)
{
	...
	if(milliseconds >= 100)
	{
		Printer::int32(milliseconds, col, row, font);
	}
	else if(milliseconds >= 10)
	{
		Printer::int32(0, col, row, font);
		Printer::int32(milliseconds, col + 1, row, font);
	}
	else
	{
		Printer::int32(0, col, row, font);
		Printer::int32(0, col + 1, row, font);
		Printer::int32(milliseconds, col + 2, row, font);
	}
}
