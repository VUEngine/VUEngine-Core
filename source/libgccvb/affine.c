...
void affineRotateZ(u16 param, fix7_9 zoomX, fix7_9 zoomY,
					 s16 bg_x, s16 bg_y, s16 fg_x, s16 fg_y, int alpha) {
	PDx_ST pdx;	
...
void affineRotateScale(u8 world,s16 alpha, float zoom,
					 s16 bg_x, s16 bg_y, s16 fg_x, s16 fg_y) {
	PDx_ST pdx;
	pdx.pb  = 0.0f;
...
void affineRotateY(u16 param,s16 alpha,float zoomX,float zoomY, s16 bg_x, s16 bg_y, s16 fg_x, s16 fg_y) {
	...
	//delay(10);
	affineSetAll(param,&pdx,(fg_y<<1)*zoomY);
...
void affineScaleProject(u16 param, 
					 s16 bg_x, s16 bg_y, s16 fg_x, s16 fg_y,float zoomX,float zoomY,float inc) {
	PDx_ST pdx;
	u16 i;
