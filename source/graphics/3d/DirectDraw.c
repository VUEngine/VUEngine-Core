...
void DirectDraw::constructor()
{
	...
	VIPManager::addEventListener(VIPManager::getInstance(), ListenerObject::safeCast(this), (EventListener)DirectDraw::onVIPManagerFRAMESTARTDuringXPEND, kEventVIPManagerFRAMESTARTDuringXPEND);
...
void DirectDraw::onVIPManagerFRAMESTARTDuringXPEND(ListenerObject eventFirer __attribute__ ((unused)))
{
