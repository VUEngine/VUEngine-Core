...
Component ComponentManager::allocateComponent(Entity owner, const ComponentSpec* componentSpec)
{
	...
	NM_ASSERT((uint32)&_textStart <= (uint32)componentSpec->allocator, "ComponentManager::create: invalid allocator");
	NM_ASSERT((uint32)&_textEnd > (uint32)componentSpec->allocator, "ComponentManager::create: invalid allocator");
#endif
