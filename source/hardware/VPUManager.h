...
#define	__PARAM_BASE	(__PARAM_TABLE_END - 0x00002000 * (__TOTAL_NUMBER_OF_BGMAPS_SEGMENTS - BgmapTextureManager_getAvailableBgmapSegments(BgmapTextureManager_getInstance())) - __PRINTABLE_BGMAP_AREA)
