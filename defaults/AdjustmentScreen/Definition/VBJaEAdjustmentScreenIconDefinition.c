...
SpriteROMDef VBJAENGINE_ADJUSTMENT_SCREEN_ICON_IM_L_SPRITE =
{
	// sprite's type
	__TYPE(Sprite),
...
SpriteROMDef* const VBJAENGINE_ADJUSTMENT_SCREEN_ICON_IM_L_SPRITES[] =
{
	&VBJAENGINE_ADJUSTMENT_SCREEN_ICON_IM_L_SPRITE,
	NULL
};

SpriteROMDef const VBJAENGINE_ADJUSTMENT_SCREEN_ICON_IM_R_SPRITE =
{
	// sprite's type
	__TYPE(Sprite),
