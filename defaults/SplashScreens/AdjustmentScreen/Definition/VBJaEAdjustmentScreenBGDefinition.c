...
BgmapSpriteROMDef VBJAENGINE_ADJUSTMENT_SCREEN_BG_IM_SPRITE =
{
	// sprite's type
	__TYPE(BgmapSprite),
...
BgmapSpriteROMDef* const VBJAENGINE_ADJUSTMENT_SCREEN_BG_IM_SPRITES[] =
{
...
{
	__TYPE(Image),
	(SpriteROMDef**)VBJAENGINE_ADJUSTMENT_SCREEN_BG_IM_SPRITES,
};